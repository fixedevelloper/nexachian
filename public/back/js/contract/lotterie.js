var lottery = function () {
    ...
    const sendLottery=async function(){
        ...
        var result = await window.mxgfcontract.methods.participate(account).send({
            from: account,
