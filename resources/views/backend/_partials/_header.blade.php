    ...
    <div class="container-fluid navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto navbar-list mb-2 mb-lg-0 align-items-center">
                <li class="nav-item">  <w3m-core-button></w3m-core-button></li>
              {{--  <li class="nav-item dropdown">
                        ...
                        <div class="card shadow-none m-0">
                            ...
                            <div class="card-body p-0 ">
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex ">
                                        <div class="">
                                            <img src="{{asset('back/images/coins/01.png')}}" class="img-fluid avatar avatar-50 avatar-rounded" alt="img55">
                                        </div>
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex">
                                        <div class="">
                                            <img src="{{asset('back/images/coins/03.png')}}" class="img-fluid avatar avatar-50 avatar-rounded" alt="img56">
                                        </div>
                                        <div class="ms-3">
                                ...
                                <a href="#" class="iq-sub-card">
                                    <div class="d-flex">
                                        <div class="">
                                            <img src="{{asset('back/images/coins/06.png')}}" class="img-fluid avatar avatar-50 avatar-rounded" alt="img57">
                                        </div>
                                        <div class="ms-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{asset('back/images/avatars/01.png')}}" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded">
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li class="border-0"><a class="dropdown-item" href="javascript(0)">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
